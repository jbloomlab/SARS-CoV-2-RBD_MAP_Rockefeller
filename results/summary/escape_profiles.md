...
```
    ...
    Plotted profile 1 to:
     ...
     results/escape_profiles/Rockefeller_antibodies_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_2.png)
    ...
    Plotted profile 3 to:
     ...
     results/escape_profiles/Rockefeller_antibodies_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_4.png)
    ...
    Plotted profile 4 to:
     results/escape_profiles/Nussenzweig_serum_stackedlogo.pdf
     results/escape_profiles/Nussenzweig_serum_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_6.png)
    ...
    Plotted profile 5 to:
     results/escape_profiles/Nussenzweig_serum_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Nussenzweig_serum_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_8.png)
    ...
    Plotted profile 6 to:
     results/escape_profiles/Nussenzweig_serum_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Nussenzweig_serum_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_10.png)
    ...
    Plotted profile 7 to:
     results/escape_profiles/NY_mabs_sera_stackedlogo.pdf
     results/escape_profiles/NY_mabs_sera_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_12.png)
    ...
    Plotted profile 8 to:
     results/escape_profiles/NY_mabs_sera_color_by_bind_stackedlogo.pdf
     results/escape_profiles/NY_mabs_sera_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_14.png)
    ...
    Plotted profile 9 to:
     results/escape_profiles/NY_mabs_sera_color_by_expr_stackedlogo.pdf
     results/escape_profiles/NY_mabs_sera_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_16.png)
    ...
    Plotted profile 10 to:
     results/escape_profiles/Weisblum_single_nt_colorescape_stackedlogo.pdf
     results/escape_profiles/Weisblum_single_nt_colorescape_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_32.png)
...
![png](escape_profiles_files/escape_profiles_26_34.png)
